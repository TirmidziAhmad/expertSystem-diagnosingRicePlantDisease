        ...
        <div className="flex flex-col items-center text-center">
          <ChartContainer className="w-full aspect-square max-w-[400px] mx-auto">
            <PieChart width={340} height={340}>
              <Pie data={chartData} dataKey="cases" nameKey="disease" cx="35%" cy="45%" outerRadius={120} label={({ percent }) => `${Math.round(percent * 100)}%`}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {chartData.map((item) => (
              <div key={item.disease} className="flex items-start space-x-2 text-sm">
